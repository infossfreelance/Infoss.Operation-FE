...
const PaymentRequestEditPage = () => {
  ...
  const getDetail = () => {
    ...
    axios
      .post(API_URL + 'PaymentRequest/PostById?id=' + SOId, payload)
      .then((response) => {
                  ...
                  >
                    ...
                    <FormControlLabel
                      ...
                      control={
                        <Radio
                          onChange={(e) =>
                            setPaymentForm('General PaymentRequest')
                          }
                        />
                      }
                ...
                <div className="col-9 border border-secondary rounded p-3">
                  ...
                  >
                    <FormControlLabel
                      ...
                      defaultChecked={true}
                      control={
                        <Radio onChange={(e) => setCTCType('Non CTC')} />
                      }
                    ...
                    <FormControlLabel
                      value="Cost To Cost"
                      defaultChecked={false}
                      control={<Radio onChange={(e) => setCTCType('CTC')} />}
                      label="Cost To Cost"
                    />
                  </RadioGroup>
                </div>
                          ...
                          IncShipperList.map((v, k) => {
                            return (
                              <ListTab1
                                ...
                                v={v}
                                SelectedShipperList={
                                  SelectedShipperList.id === v.id ? true : false
                                }
                  ...
                  >
                    <div className="col-xl-5">
                      <FormControlLabel
                        ...
                        defaultChecked={true}
                        control={
                          <Radio onChange={(e) => setTotalUSD('Paid')} />
                        }
                        label="Paid"
                      />
                    </div>
                    <div className="col-xl-7">
                      <FormControlLabel
                        ...
                        defaultChecked={false}
                        control={
                          <Radio onChange={(e) => setTotalUSD('Not Paid')} />
                        }
                        label="Not Paid"
                      />
                    </div>
                  ...
                  >
                    <div className="col-xl-5">
                      <FormControlLabel
                        ...
                        defaultChecked={true}
                        control={
                          <Radio onChange={(e) => setTotalIDR('Paid')} />
                        }
                        label="Paid"
                      />
                    </div>
                    <div className="col-xl-7">
                      <FormControlLabel
                        ...
                        defaultChecked={false}
                        control={
                          <Radio onChange={(e) => setTotalIDR('Not Paid')} />
                        }
                        label="Not Paid"
                      />
                    </div>
