...
const EstimateProfitLossPage = () => {
    ...
    const getData = (param = "", value = "") => {
        setIsLoading(true);
        const payload = {
            userCode: "string", countryId: 101, companyId: 32, branchId: 12, filter: [{
    ...
    const handleDelete = () => {
        ...
        Swal.fire({
            ...
            .then((result) => {
                if (result.value) {
                    const payload = {
                        userCode: "string", countryId: 101, companyId: 32, branchId: 12
                    }
    ...
    return (<section>
        ...
        <Snackbar open={OpenAlert} autoHideDuration={5000} onClose={handleClose} anchorOrigin={{vertical, horizontal}}
        ...
        <div className='mt-3 border rounded-10 p-2'>
            {isLoading ? <LoadingSpinner/> : <>
                <Table className="table-borderless">
                    ...
                    <tr>
                        <td>
                            <select className='form-control col-search-form border-infoss'
                                    onChange={(e) => getDataFilter("deleted", e.target.value)}>
                        ...
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("shipmentId", e.target.value)}/>
                        </td>
                        <td>
                            <select className='form-control col-search-form border-infoss'
                                    onChange={(e) => getDataFilter("isCostToCost", e.target.value)}>
                                <option value="">All</option>
                                <option value="true">Yes</option>
                                <option value="false">No</option>
                            </select>
                        ...
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("prContraNo", e.target.value)}/>
                        </td>
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("reference", e.target.value)}/>
                        </td>
                        <td>
                            <input className="form-control col-search-form border-infoss"
                        ...
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("paymentUSD", e.target.value)}/>
                        </td>
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("paymentIDR", e.target.value)}/>
                        </td>
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("printedOn", e.target.value)}/>
                        </td>
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("customerId", e.target.value)}/>
                        </td>
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("rate", e.target.value)}/>
                        </td>
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("exRateDate", e.target.value)}/>
                        </td>
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("createdOn", e.target.value)}/>
                        </td>
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("", e.target.value)}/>
                        ...
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("printing", e.target.value)}/>
                        </td>
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("totalPpnUSD", e.target.value)}/>
                        </td>
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("totalPpnIDR", e.target.value)}/>
                        </td>
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("vendorDN", e.target.value)}/>
                        </td>
                        <td>
                            <input className="form-control col-search-form border-infoss"
                                   onChange={(e) => getDataFilter("", e.target.value)}/>
                    ...
                    {EPLDataMap.length ? EPLDataMap.map((v, k) => {
                        return (<PRRow
                            key={k}
                            k={k + 1}
                            v={v}
